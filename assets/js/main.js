...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $('#slider-area').on("translate.owl.carousel", function (e) {
            $(".hero-text").removeClass("animated fadeInUp").css("opacity", "0");
            $(".hero-iamge").removeClass("animated fadeInUp").css("opacity", "0");
        });

        $('#slider-area').on("translated.owl.carousel", function (e) {
            $(".hero-text").addClass("animated fadeInUp").css("opacity", "1");
            $(".hero-iamge").addClass("animated fadeInUp").css("opacity", "1");
        });
